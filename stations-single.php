<?php 
  ...
  // station in the link
  $station_link_sql = "SELECT nimi, namn, x, y, osoite FROM stations WHERE nimi = '$station_name'";
  ...
  $total_journeys_started_sql = "SELECT count(journeys.departure_station_id) as startedjourneys FROM journeys INNER JOIN stations ON journeys.departure_station_id = stations.id WHERE stations.nimi = '$station_link_res_name'";
  ...
  $total_journeys_ended_sql = "SELECT count(journeys.return_station_id) as endedjourneys FROM journeys INNER JOIN stations ON journeys.return_station_id = stations.id WHERE stations.nimi = '$station_link_res_name'";
  ...
  <body>
    ...
    <div class="row">
      ...
      <div class="col l7 s12 " id="data-box">
        ...
        <div class="row">
          <div class="col s5 offset-s1" id ="left-col">
            <p class="label">Average distance of started journey</p>
            <h5 class="bold-text"><?php echo $total_journeys_started_res?></h5>
          </div>
          <div class="col s5" id ="right-col">
